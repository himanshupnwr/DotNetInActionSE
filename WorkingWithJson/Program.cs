...
namespace WorkingWithJson
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //StreamReader is a wrapper that lets you read a Stream object line by line
            ...
            static void FindWithJsonDom1(Stream inStream, Stream outStream, string category)
            {
            ...
            static void FindWithJsonDom2(Stream inStream, Stream outStream, string category)
            {
            ...
            static void FindWithJsonDom3(Stream inStream, Stream outStream, string category)
            {
                var writerOptions = new JsonWriterOptions { Indented = true };
                using var writer = new Utf8JsonWriter(outStream, writerOptions);
                writer.WriteStartArray();
            ...
            static void FindWithSerialization(Stream inStream, Stream outStream, string category)
            {
                ...
                JsonSerializer.Serialize(outStream, jokes?.Where(j => string.Equals(category, j.Type,
